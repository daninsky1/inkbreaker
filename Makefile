...
$(DEBUG_PROGRAM): $(SRC)
	...
	$(CC) $(DCFLAGS) $(SRC) $(SYS_LIBS) $(FLTK_LIB) /Fo$(BUILD_DIR)debug/ /Fe$(BUILD_DIR)debug/$(DEBUG_PROGRAM) $(INCLUDE_DIR) /link /PDB:$(BUILD_DIR)debug/$(DEBUG_PROGRAM_NAME).pdb
