    ...
    int View2D::handle_draw_mode(int evt)
    {
        ...
        if (evt == FL_KEYBOARD) {
            ...
            case FL_Enter: {
                if (is_drawing) {
                    ...
                    else if (temp_shape->type() == "bezier") {
        ...
        case FL_MOVE: {
            if (is_drawing) {
                ...
                //printf("temp_shape first 4 nodes: p0: %f, %f | h0: %f, %f | h1: %f, %f | p1: %f, %f\n",
                //    temp_shape->nodes[0].pos.x, temp_shape->nodes[0].pos.y,
                //    temp_shape->nodes[1].pos.x, temp_shape->nodes[1].pos.y,
                //    temp_shape->nodes[2].pos.x, temp_shape->nodes[2].pos.y,
                //    temp_shape->nodes[3].pos.x, temp_shape->nodes[3].pos.y);
                //printf("active_bpoint: %f, %f | active_head_bhandle: %f, %f | tail_bhandle: %f, %f\n",
                //    active_bpoint->pos.x, active_bpoint->pos.y,
                //    active_head_bhandle->pos.x, active_head_bhandle->pos.y,
                //    tail_bhandle->pos.x, tail_bhandle->pos.y);
                redraw();
                handled = 1;
            }
        } break;
